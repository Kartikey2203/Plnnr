  ...
  return (
    <div className="min-h-screen pt-24 pb-20 px-4">
      ...
      {selectedTicket && (
        ...
        >
          <DialogContent className="max-w-[360px] w-full p-0 overflow-hidden bg-zinc-950 border-zinc-800">
            <DialogHeader className="p-6 pb-2">
              <DialogTitle className="text-center text-xl">Your Ticket</DialogTitle>
            </DialogHeader>
